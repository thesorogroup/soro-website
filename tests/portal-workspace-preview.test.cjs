...
test('Admin workspace previews map all five choices to the real role navigation', () => {
  ...
  assert.deepEqual(roleViews(source, 'admin'), ['overview', 'tasks', 'clients', 'vas', 'talent-profile', 'placements', 'documents', 'reports', 'employees', 'help']);
  assert.deepEqual(roleViews(source, 'sales'), ['overview', 'tasks', 'clients', 'placements', 'reports', 'help']);
  assert.deepEqual(roleViews(source, 'talent_management'), ['overview', 'tasks', 'clients', 'vas', 'talent-profile', 'placements', 'documents', 'reports', 'help']);
