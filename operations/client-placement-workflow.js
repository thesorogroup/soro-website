...
(function attachSoroClientPlacementWorkflow(root, factory) {
  ...
  function placementMarkup(placement, clientSafe) {
    ...
    return `<article class="cpw-placement">
      ...
      ${checklist}
      ${!clientSafe && (!mountedOptions.adapter || root.SoroTestSession) && root.SoroPlacementCheckins?.allowed() ? `<p><button type="button" class="cpw-button cpw-button--secondary" data-placement-checkins="${escapeHtml(placement.placementId)}">Check-ins</button></p>` : ''}
