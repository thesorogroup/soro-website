  ...
  function hubMarkup(client) {
    ...
    return `<main class="page client-workflow-page client-workflow-hub" data-client-workflow data-client-workflow-state="hub" data-client-id="${escapeHtml(client.id)}">
      ...
      <div class="client-workflow-hub-grid">
        ...
        <section class="panel client-workflow-activity-card" aria-labelledby="client-workflow-activity-title"><div class="client-workflow-section-heading"><div><p class="eyebrow">Changes & actions</p><h2 id="client-workflow-activity-title">Activity History</h2></div><button type="button" class="button" data-activity-kind="client" data-activity-id="${escapeHtml(client.id)}">View history</button></div><p>Search recorded actions, assignments, and workflow updates for this Client.</p></section>
      </div>
